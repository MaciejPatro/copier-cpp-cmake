...
<img
    ...
    src="/copier-cpp-cmake/img/logo.svg" alt="logo"/>
...
- **To be able to manage code lifecycle**. When the template evolves users can update their existing project to benefit
from the newest technologies and solutions without complex manual tinkering.
